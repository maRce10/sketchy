...
#' comments = NULL, packrat = FALSE, clone = NULL)
...
make_compendium <- function(name = "research_compendium", path = ".", force = FALSE, format, comments = NULL, packrat = FALSE, clone = NULL)
  {
    ...
    cat(crayon::green("Creating directories ...\n")) else
      cat(crayon::green("Setting proyect on an existing directory ...\n"))
