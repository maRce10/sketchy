...
#uninstall sketchy 
```{r reinstall sketchy from github, eval=F}
...
x <- c( "devtools", "pkgdown", "spelling", "maRce10/sketchy")
...
#tests  
make_compendium(name = "projescto_x", format = "basic", force = TRUE, path = tempdir())

# no comments
make_compendium(name = "projecto_x2", format = "basic", force = TRUE, path = tempdir(), comments = FALSE)


make_compendium(name = "pruebaX3", format = compendiums$basic$skeleton, force = TRUE, path = tempdir())

make_compendium(name = "pruebaX31", format = compendiums$basic$skeleton, force = TRUE, path = tempdir(), comments = compendiums$basic$comments)

make_compendium(name = "pruebaX32", format = compendiums$figures$skeleton, force = TRUE, path = tempdir())

make_compendium(name = "pruebaX33", format = "boettiger", force = TRUE,  path = tempdir())

make_compendium(name = "pruebaX34", format = "pakillo", force = TRUE, comments = NULL, path = tempdir())

make_compendium(name = "prueba6666", format = "sketchy", force = TRUE, comments = NULL, path = tempdir())


make_compendium("prueba7", format = type2, path = tempdir())


ld <- readRDS("../example_complex_structure.RDS")
...
make_compendium(name = repo_name, format = compendiums$basic$skeleton, force = TRUE, path = tempdir(), comments = compendiums$basic$comments, git = TRUE)
...
print_skeleton(path = "~/Dropbox/R_package_testing/warbleR/warbleR/")
...
rdir_skeleton <- c("code", "code/processed/", "code/raw", "data/raw", "data/clean", "figures","figures/exploratory", "figures/final/", "text", "text/final", "text/notes")
...
extra_css <- readLines("./examples/extra.css")

example_library <- readLines("./examples/example_library.bib")


internal_files <- list(manuscript_template = manuscript_template, apa.csl = apa.csl, readme_template = readme_template, analysis_template = analysis_template, extra_css = extra_css, example_library = example_library)
