...
#tests  
sketchy::make_compendium(name = "projecto_x", format = "basic", force = TRUE, path = tempdir())

make_compendium(name = "pruebaX", format = compendiums$basic$skeleton, force = TRUE, path = tempdir(), comments = compendiums$basic$comments)

  
make_compendium(name = "pruebaX", format = compendiums$figures$skeleton, force = TRUE)

make_compendium(name = "pruebaX", format = compendiums$pakillo$skeleton, force = TRUE)


make_compendium("prueba7", format = type2)


ld <- readRDS("../example_complex_structure.RDS")

make_compendium("pruebaZ", format =  ld, force = TRUE)
...
make_compendium(name = "prue23b33a", format = "figures", force = TRUE, path = tempdir(), comments = compendiums$basic$comments)

  
print_skeleton(path = file.path(tempdir(), "pruebaX"), comments = compendiums$basic$comments)
...
sketchy_info <- "sketchy's own design"
