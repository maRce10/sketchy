...
# custom format
make_compendium(name = "projass", format = c("folder_1", "folder_1/subfolder_1", "folder_1/subfolder_2"), force = TRUE, path = tempdir())
...
analysis_template_rmarkdown <- readLines("./examples/analysis_template_rmarkdown.Rmd")
...
internal_files <- list(manuscript_template = manuscript_template, apa.csl = apa.csl, readme_template = readme_template, analysis_template_rmarkdown = analysis_template_rmarkdown, analysis_template_quarto = analysis_template_quarto, rmd_css = rmd_css, qmd_css = qmd_css, example_library = example_library)
